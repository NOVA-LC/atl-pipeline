...
===========================================================================
DESIGN DOCTRINE (verbatim from Anthropic's frontend-aesthetics cookbook)
===========================================================================
...
- Our type-pair catalog already excludes Inter and Arial as DISPLAY faces.
  Inter is body-text only (it's a workhorse). Display picks come from
  Fraunces / Oswald / Archivo / Playfair / DM Serif Display / Bebas Neue /
  IBM Plex Sans / Cormorant / Anton / Lora / Space Mono / Abril Fatface.
  NEVER pick Space Grotesk — it's the new convergence default the cookbook
  flags by name.
- Our motion library is GSAP+Lenis with 12 named presets, picked per-section
  with no-adjacent-duplicates. Use the rhythm rule, don't pile motion on every
  section.
- Our palette tokens use named recipes (heritage-navy-gold, rugged-shop-orange,
  clean-trade-blue, modern-charcoal, warm-earth, emergency-red). Pick a
  dominant + accent that has tension; reject palettes where accent disappears
  against the body color.
- LOCAL TRADES VERTICAL CAVEAT: this is a plumber/HVAC/auto-shop site, not a
  SaaS landing page. The buyer is an SMB owner skimming on mobile in 5
  seconds. Distinctive ≠ ornate — distinctive means "looks built for THIS
  business," not "covered in motion and shadows." Conversion fundamentals
  (huge tel:, reviews, license #, neighborhoods) are non-negotiable; the
  aesthetic doctrine above lifts the page above template-tier WITHOUT
  burying those fundamentals.
